...
<script type="text/javascript" src="{{asset('vendor/menu/scripts.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/menu/scripts2.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/menu/menu.js')}}"></script>